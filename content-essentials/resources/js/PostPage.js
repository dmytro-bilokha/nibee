...
function CommentFormHandler() {
	...
	this.form = document.getElementById("newCommentForm");
	this.postIdInput = document.getElementById("postIdInput");
	this.commentIdInput = document.getElementById("commentIdInput");
	this.submitButton = document.getElementById("submitCommentButton");
	this.cancelButton = document.getElementById("cancelCommentButton");
	this.closeButton = document.getElementById("closeCommentFormButton");
	this.headerDiv = document.getElementById("commentFormHeaderText");
	this.clientErrorDiv = document.getElementById("commentFormClientError");
	this.serverErrorDiv = document.getElementById("commentFormServerError");
	this.authorNicknameInput = document.getElementById("authorNicknameInput");
	this.authorNicknameError = document.getElementById("authorNicknameError");
	...
	if (!this.authorNicknamePattern.test(this.authorNicknameInput.value)) {
	    this.authorNicknameError.children[1].innerHTML = "Nickname should contain only latin letters (a-z, A-Z) and digits (0-9)";
	    this.authorNicknameError.className = "errorRow";
	    return false;
	}
	return true;
